...
public class ParentAdapter extends RecyclerView.Adapter<ParentAdapter.MyViewHolder> implements RvClickInterface {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_parent_list, parent, false);
...
//                    v.getContext().startActivity(intent);
                    ...
                    Intent intent = new Intent(v.getContext(), SliderViewMain.class);
                    v.getContext().startActivity(intent);
